...
def main():
    ...
    set_logging_configuration(debug=get_agent_settings().nuvlaedge_debug,
                              log_level=logging.getLevelName(get_agent_settings().nuvlaedge_log_level),
                              log_path=get_agent_settings().nuvlaedge_logging_directory,
                              disable_file_logging=get_agent_settings().disable_file_logging)
