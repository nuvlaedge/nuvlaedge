...
import requests
import unittest
import nuvlaedge.system_manager.common.container_runtime as container_runtime
import tests.system_manager.utils.fake as fake


class DockerTestCase(unittest.TestCase):

    @mock.patch('nuvlaedge.system_manager.common.container_runtime.Docker.load_data_gateway_network_options')
    def setUp(self, mock_load_data_gateway_network_options) -> None:
        mock_load_data_gateway_network_options.return_value = {}
        self.obj = container_runtime.Docker(logging)
    ...
    @mock.patch.object(container_runtime.Docker, 'find_network')
    @mock.patch('nuvlaedge.system_manager.common.container_runtime.Path')
    ...
    def test_load_data_gateway_network_options(self, mock_exists, mock_path, mock_find_network):
        ...
        mock_exists.assert_called_once_with(container_runtime.utils.nuvlaedge_shared_net_unencrypted)
        ...
        mock_find_network.assert_called_once_with(container_runtime.utils.nuvlaedge_shared_net)
        ...
        mock_path.assert_called_once_with(container_runtime.utils.nuvlaedge_shared_net_unencrypted)
    ...
    def test_list_internal_components(self):
        self.assertIsNotNone(container_runtime.utils.base_label,
    ...
    @mock.patch.object(container_runtime.Docker, 'get_node_info')
    ...
    @mock.patch.object(container_runtime.Docker, 'get_version')
    ...
    @mock.patch.object(container_runtime.Docker, 'infer_on_stop_docker_image')
    ...
    @mock.patch.object(container_runtime.Docker, 'read_system_issues')
    @mock.patch.object(container_runtime.Docker, 'get_node_info')
    @mock.patch.object(container_runtime.Docker, 'get_node_id')
    def test_set_nuvlaedge_node_label(self, mock_get_node_id, mock_get_node_info, mock_read_system_issues):
        ...
        node.attrs = {'Spec': {'Labels': {container_runtime.utils.node_label_key: 'foo'}}}   # already labeled
        self.obj.client.nodes.get.return_value = node
        ...
        node.update.assert_called_once_with({'Labels': {container_runtime.utils.node_label_key: 'True'}})
    ...
    @mock.patch.object(container_runtime.Docker, 'get_current_container')
